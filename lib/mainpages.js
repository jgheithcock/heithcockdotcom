...
export function getPosts(slug, fields = []) {
  ...
  const sortPosts = (post1, post2) => {
    console.log(`comparing ${post1.title} to ${post2.title}`);
...
export function getNavPosts(slug, fields = ["title", "slug"]) {
  /*
    Desired behavior:
  ...
  */
  ...
  // console.log("children.length", children.length, ", children:", children);
